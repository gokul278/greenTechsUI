        ...
        <div className="hidden w-full lg:flex justify-end items-center">
          <div className="flex w-full justify-end items-center gap-4 pr-4">
            {menus.map((menu, index) => (
              <div
                key={index}
                className={`w-auto flex justify-center items-center text-center cursor-pointer ${
                  selectedMenu === menu.label ? "text-[#008080]" : "text-[#000]"
                }`}
                onClick={() => {
          ...
          {profileMenu && (
            <div
              ref={menuRef}
              className="absolute top-[7.5vh] w-50 right-2 py-2 rounded-xl bg-[#f0f0f0]"
              style={{
                boxShadow:
          ...
          >
            ...
            <div className="flex flex-col mt-6 gap-2 pr-4">
              ...
              {menus.map((menu, index) => (
                <div
                  key={index}
                  className={`w-full p-2 rounded-sm px-3 cursor-pointer ${
